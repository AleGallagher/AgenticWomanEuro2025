...
async def get_qualification_options(model: Annotated[ChatOpenAI, InjectedToolArg], question: str = "", question_language: Annotated[str, InjectedToolArg] = "English") -> str:
    """
    ...
    """
    result = await handle_qualification_question(llm=model, question=question, question_language=question_language)
